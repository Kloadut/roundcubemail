...
$rcmail_config['support_url'] = 'http://jappix.yunohost.org/?r=support@conference.yunohost.org';
...
$rcmail_config['des_key'] = 'rcmail-ynhDESkeyTOchange';
...
$rcmail_config['product_name'] = 'YunoHost Webmail';
...
$rcmail_config['archive_mbox'] = 'Trash';

// display these folders separately in the mailbox list.
// these folders will also be displayed with localized names
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['default_folders'] = array('INBOX', 'Drafts', 'Sent', 'Junk', 'Archive', 'Trash');
...
$rcmail_config['logout_url'] = 'https://'.$main_domain.'/sso/index.pl?logout=1';
